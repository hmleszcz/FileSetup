...
## y_ij is the observed value for item j for unit i. 
## For each item alpha_j and beta_j are also estimated. 
## alpha_j continues to act as "difficulty" parameters, or threshold that benchmarks how 
## likely an indicator is to be observed relative to the values of the latent trait.  
## In this formulation, this is analogous to an intercept in a traditional logistic regression model. 
## beta_j, often referred to as the "discrimination" parameters and is the analogue of a slope coefficient.
##
##########################################################################
